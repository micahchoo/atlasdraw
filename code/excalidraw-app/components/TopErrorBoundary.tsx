...
// stripped: Sentry per ADR 0006 (Phase 0 Task 9b)
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: any) {
    ...
    // stripped: Sentry per ADR 0006 (Phase 0 Task 9b)
    // TODO Phase 0 Task 9b — Sentry boundary neutered, typed state kept (sentryEventId stays empty string)
    console.error("captured (was Sentry):", error);
    this.setState({
      hasError: true,
      sentryEventId: "",
