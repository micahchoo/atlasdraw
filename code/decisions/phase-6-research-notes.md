...
**Date:** 2026-05-03 **Researcher:** open-questions resolver agent (claude-sonnet-4-6) **Plan:** `docs/superpowers/plans/2026-05-03-atlasdraw-phase-6-v1-embeds-comments.md` **Method:** Primary-source web fetch via context-mode sandbox (raw HTML never entered context)
...
**Approved MIT/CC0 alternatives for Task 14b:** | Source | License | Notes | |---|---|---| | [Phosphor Icons](https://github.com/phosphor-icons/core) | MIT | Large set, well-maintained, SVG | | [Heroicons](https://github.com/tailwindlabs/heroicons) | MIT | Tailwind Labs, SVG, outline + solid | | [Lucide](https://github.com/lucide-icons/lucide) | ISC | MIT-compatible fork of Feather Icons | | Hand-drawn in-house SVG | MIT by authorship | Best provenance story | | CC0/public domain SVG | CC0 | Any CC0-licensed collection |
