...
import { pointFrom, type LocalPoint, type Radians } from "@atlasdraw/math";

import { DEFAULT_VERTICAL_ALIGN, ROUNDNESS, assertNever } from "@atlasdraw/common";
