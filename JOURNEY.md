...
| 4 | Dismiss the error dialog | Close button or Escape | Dialog renders **no close button** and Escape does nothing; only discoverable dismissal is clicking the backdrop margin around the modal | 2 | pending | re-walked: X button renders, focus lands in dialog, Escape dismisses |
